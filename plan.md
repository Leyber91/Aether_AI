...
|          | RT-02     | Fallback Hierarchy: 1. Preferred Local GPU (Ring 1/2). 2. Pinned Local GPU (Ring 0). 3. Groq (if enabled & quota OK). 4. Suggest alternative local task (e.g., summarize). 5. CPU Fallback (qwen3:1.7b). 6. Error. | RT-01, F-19 |
