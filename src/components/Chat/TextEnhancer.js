...
const TextEnhancer = ({ 
  ...
  return (
    <>
      {/* Add an overlay to prevent click-through and ensure this stays on top */}
      {isOpen && (
        <div 
          className="text-enhancer-overlay"
          onClick={() => onClose()}
          style={{
            position: 'fixed',
            top: 0,
      ...
      <div className="text-enhancer-container" style={{ zIndex: 9950 }}>
