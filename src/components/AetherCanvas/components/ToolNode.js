...
const ToolNode = ({ data, id, nodeStatus, runningNodes, isFlowRunning, runNode, connectingFromNodeId, handleConnectButton, handleTargetButton, handleCancelConnect }) => {
  ...
  return (
    <div className={styles.toolNode} data-status={nodeHasStatus ? safeNodeStatus[safeId] : 'idle'}>
      <Handle type="target" position={Position.Left} id="a" />
      <Handle type="source" position={Position.Right} id="a" />
      <ToolIcon className={styles.nodeIcon} /> {data?.label}
